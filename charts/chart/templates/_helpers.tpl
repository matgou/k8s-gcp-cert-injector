...
*/}}
{{- define "k8s-gcp-cert-injector.name" -}}
...
*/}}
{{- define "k8s-gcp-cert-injector.fullname" -}}
...
*/}}
{{- define "k8s-gcp-cert-injector.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "k8s-gcp-cert-injector.resourceName" -}}
{{- $fullname := include "k8s-gcp-cert-injector.fullname" .context }}
{{- $suffix := .suffix }}
