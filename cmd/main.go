...
import (
	...
	"github.com/matgou/k8s-gcp-cert-injector/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8f1b528d.cert-injector.io",
	})
	if err != nil {
	...
	// 3. Register SecretReconciler controller with the Manager, injecting the concrete store implementation
